  ...
  return (
    <View style={{ flex: 1 }}>
        ...
        <View style={styles.sliderContainer}>
            <Swiper showsButtons={true} autoplay={true} dotColor={colors.white} activeDotColor={colors.primary}>
                ...
                <View style={styles.slide3}>
                    ...
                    {/* <Image source={{ uri: "https:/bukasapics.s3.us-east-2.amazonaws.com/plate4.png" }} /> */}
                </View>
        ...
        <View style={{ flex: 2, marginTop: 30 }}>
            ...
            <View style={{marginHorizontal: 20}}>
                <TouchableOpacity style={{...params.styledButtonOutline, marginTop: 20}}>
                    <Text style={{...params.styledTitle, color: colors.primary}}>SIGN UP</Text>
                </TouchableOpacity>
            </View>
        </View>
    </View>
